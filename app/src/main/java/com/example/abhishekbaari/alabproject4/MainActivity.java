...
public class MainActivity extends AppCompatActivity {
    ...
    private final String Url="http://schoolian.website/android/parent/checking.php";
    private final String Url2="http://schoolian.website/android/parent/parentRegister.php";
    boolean i=false;
...
sessionManger=new SessionManger(this);
        ...
        button.setOnClickListener( new View.OnClickListener() {
            ...
            if(!Mobiles.isEmpty())
            {
                ...
                if (otp.sendOtp())
                {
                    Toast.makeText(MainActivity.this, "OTP Sending...", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if (success.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            Intent intent=new Intent(MainActivity.this,ForProfile.class);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success.equals("1"))
                    {
                        sidTT.setText("Student ID:"+msg);
                        Sid=sid;
                        button.setEnabled(true);
                    }
                    else if(success.equals("2"))
                    {
                        sidTT.setText("Student ID: Invalid ID");
                        int color = Color.parseColor("#FF0000");
